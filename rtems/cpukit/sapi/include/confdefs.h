...
#ifdef CONFIGURE_ENABLE_BSP_LED_DRIVER
	#include <rtems/led-drv.h>
#endif

#ifdef CONFIGURE_ENABLE_BSP_I2C_DRIVER
 ...
 */
  ...
  rtems_driver_address_table
    ...
    #endif
    #ifdef CONFIGURE_APPLICATION_EXTRA_DRIVERS
      CONFIGURE_APPLICATION_EXTRA_DRIVERS_ENTRY,
	//  RAMDISK_DRIVER_TABLE_ENTRY,
    #endif
	#ifdef CONFIGURE_ENABLE_BSP_LED_DRIVER
	  CONFIGURE_ENABLE_BSP_LED_DRIVER_ENTRY,
	#endif
	#ifdef CONFIGURE_ENABLE_BSP_I2C_DRIVER
	  CONFIGURE_ENABLE_BSP_I2C_DRIVER_ENTRY,
	#endif
      ...
      NULL_DRIVER_TABLE_ENTRY
		...
		!defined(CONFIGURE_ENABLE_BSP_LED_DRIVER) && \
	    !defined(CONFIGURE_ENABLE_BSP_I2C_DRIVER)
      NULL_DRIVER_TABLE_ENTRY
    #endif
  };
