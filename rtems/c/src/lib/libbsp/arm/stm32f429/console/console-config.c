...
console_tbl Console_Configuration_Ports [] = {
  #ifdef STM32F4_ENABLE_USART_1
    {
      ...
      .ulCtrlPort2 = 0,
      .ulDataPort   = DMA_USART1_TX_CHANNEL,
  ...
  #ifdef STM32F4_ENABLE_USART_2
    {
      ...
      .ulCtrlPort2 = 1,
      .ulDataPort   = DMA_USART2_TX_CHANNEL,
      .ulClock = STM32F4_USART_BAUD,
  ...
  #ifdef STM32F4_ENABLE_USART_3
    {
      ...
      .ulCtrlPort2 = 2,
      .ulDataPort   = DMA_USART3_TX_CHANNEL,
      .ulClock = STM32F4_USART_BAUD,
  ...
  #ifdef STM32F4_ENABLE_UART_4
    {
      ...
      .ulCtrlPort2 = 3,
      .ulDataPort   = DMA_UART4_TX_CHANNEL,
      .ulClock = STM32F4_USART_BAUD,
  ...
  #ifdef STM32F4_ENABLE_USART_6
    {
      ...
      .ulDataPort   = DMA_USART3_TX_CHANNEL,
      .ulClock = STM32F4_USART_BAUD,
      .ulDataPort   = DMA_UART5_TX_CHANNEL,
...
iwrite_t  iwrite_control[PORT_COUNT];
