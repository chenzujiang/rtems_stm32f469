...
#include <bsp/stm32f4_eth_gpio.h>
...
const stm32f4_gpio_config stm32f4_start_config_gpio [] = {
  ...
  //STM32F4_PIN_USART1_RX_PB7,
    ...
    STM32F4_PIN_I2C_SCL_PH4,
    STM32F4_PIN_I2C_SDA_PH5,
  #endif
  ...
  STM32F4_PIN_LED_PD13, /**@ LED */
  STM32F4_EXT_MEM_PIN_ALL, /**@ Extern memory */
  STM32F4_KEY_PINS,
  STM32F4_PIN_ETH_GPIO,
  

  STM32F4_GPIO_CONFIG_TERMINAL /**@ End */
};
