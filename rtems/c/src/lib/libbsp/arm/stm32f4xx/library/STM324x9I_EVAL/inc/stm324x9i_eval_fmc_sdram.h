...
/* #define SDRAM_MEMORY_WIDTH    FMC_SDMemory_Width_16b FMC_SDMemory_Width_32b */
#define SDRAM_MEMORY_WIDTH    FMC_SDMemory_Width_16b  /* Default configuration used with LCD */
/**
  * @}
  */  
