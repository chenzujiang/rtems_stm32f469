...
/**
  ...
  * @retval None
  */
static void QSPI_GPIO_Conf(void)
{
  ...
  rtems_interrupt_handler_install(
	STM32F4XX_IRQ_QUADSPI,
    "QSPI_INT",
    RTEMS_INTERRUPT_UNIQUE,
    (rtems_interrupt_handler) QSPI_isr,
    NULL);
}
void qspi_conf()
{
