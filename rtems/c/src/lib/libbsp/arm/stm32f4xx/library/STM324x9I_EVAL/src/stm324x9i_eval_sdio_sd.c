...
//add by hw 2015.12.18 for F469I-DISCO:
...
#else
rtems_isr SD_isr(rtems_vector_number vector)
#endif
{
...
#else
rtems_isr SDIO_DAM_isr(rtems_vector_number vector)
#endif
{
...
SD_Error SD_Init(void)
{
  ...
  rtems_interrupt_handler_install(
    ...
    (rtems_interrupt_handler) SDIO_isr,
    NULL);

  rtems_interrupt_handler_install(
	STM32F4XX_IRQ_DMA2_Stream3,
    "SDIO_DAM",
    RTEMS_INTERRUPT_UNIQUE,
    (rtems_interrupt_handler) SDIO_DAM_isr,
    NULL);
  return(errorstatus);
}
