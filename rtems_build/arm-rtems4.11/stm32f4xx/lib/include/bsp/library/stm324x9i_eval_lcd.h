...
#include <bsp/library/fonts.h>//����.o�ļ�ԭ������������ļ����ж�������
//#include <bsp.h>
...
static uint32_t LCD_PIXEL_HEIGHT =800;//��
#define  VSYNCH     1
#define  VBP        16
#define  VFP        15
#define  VACT       800
...
#define  HACT       480
#else
static uint32_t LCD_PIXEL_WIDTH  =800;
static uint32_t LCD_PIXEL_HEIGHT =480;
#define VSYNCH      12 
#define VBP         12 
#define VFP         12 
#define VACT        480
...
#define LCD_I2C_SCL_SOURCE               GPIO_PinSource8
...
/** @defgroup STM324x9I_EVAL_LCD_Exported_Functions
  * @{
  */
static uint32_t CurrentLcd = USE_LED_OTM800480;
